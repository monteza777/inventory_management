                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('items-mgmt.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('item_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="item_code" type="text" class="form-control" name="item_code" value="{{ old('item_code') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('uom') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="uom" type="text" class="form-control" name="uom" value="{{ old('uom') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('qty') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="qty" type="text" class="form-control" name="qty" value="{{ old('qty') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('buying_price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="buying_price" type="text" class="form-control" name="buying_price" value="{{ old('buying_price') }}" required>
